...
MESSAGE( STATUS "current DDK path in FindDDK.cmake: ${_DDK_ROOT_PATHS}")
#
...
MESSAGE( STATUS "DDK host lib path in FindDDK.cmake: ${_DDK_HOST_LIB_PATHS}")
MESSAGE( STATUS "DDK host path suffixes in FindDDK.cmake: ${_DDK_HOST_PATHS_SUFFIXES}")
...
if(NOT DDK_FOUND)
    ...
    #opencv include path
    set(DDK_INCLUDE_DIRS ${DDK_INCLUDE_DIRS} $ENV{DDK_HOME}/include/third_party/opencv/include)
    ...
    #opencv
    find_ddk_host_lib(DDK_OPENCV_LIBRARY opencv_world)
